...
const (
	TodoService_AddTodo_FullMethodName          = "/data.TodoService/AddTodo"
	TodoService_UpdateTodoStatus_FullMethodName = "/data.TodoService/UpdateTodoStatus"
	TodoService_DeleteTodoById_FullMethodName   = "/data.TodoService/DeleteTodoById"
	TodoService_GetTodoList_FullMethodName      = "/data.TodoService/GetTodoList"
)
