...
const (
	TodoService_AddTodo_FullMethodName   = "/service.TodoService/AddTodo"
	TodoService_ListTodos_FullMethodName = "/service.TodoService/ListTodos"
)
...
type TodoServiceClient interface {
	AddTodo(ctx context.Context, in *pbdata.TodoItem, opts ...grpc.CallOption) (*pbdata.TodoItem, error)
	ListTodos(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*pbdata.TodoList, error)
}
...
func (c *todoServiceClient) AddTodo(ctx context.Context, in *pbdata.TodoItem, opts ...grpc.CallOption) (*pbdata.TodoItem, error) {
	out := new(pbdata.TodoItem)
...
func (c *todoServiceClient) ListTodos(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*pbdata.TodoList, error) {
	out := new(pbdata.TodoList)
...
type TodoServiceServer interface {
	AddTodo(context.Context, *pbdata.TodoItem) (*pbdata.TodoItem, error)
	ListTodos(context.Context, *emptypb.Empty) (*pbdata.TodoList, error)
}
...
func (UnimplementedTodoServiceServer) AddTodo(context.Context, *pbdata.TodoItem) (*pbdata.TodoItem, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddTodo not implemented")
}
func (UnimplementedTodoServiceServer) ListTodos(context.Context, *emptypb.Empty) (*pbdata.TodoList, error) {
...
func _TodoService_AddTodo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoServiceServer).AddTodo(ctx, req.(*pbdata.TodoItem))
	}
...
var TodoService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/proto/service/todo.proto",
}
